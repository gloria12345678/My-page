  ...
  function fetch_i18 (json){
    ...
    .then(function(response) {
      ...
      .then(function(json) {
        ...
        var txt1 ='<p>'+json[0].name+'</p><p>'+json[0].sex+'</p><p>'+json[0].old+'</p><p>'+json[0].telephone+'</p><p>'+json[0].email+'</p>';
        pro[ArrayNum].innerHTML = txt1
        var txt2 ='<p>'+json[0].birthday+'</p><p>'+json[0].access+'</p><p>'+json[0].education+'</p><p>'+json[0].lasteducation+'</p><p>'+json[0].page+'</p>';
